<template>
		...
		<f7-views>
			<f7-view id="main-view" navbar-through :dynamic-navbar="true" main>
				...
				<f7-navbar>
					...
					<f7-nav-center sliding>ScoutOut</f7-nav-center>
					<f7-nav-right>
				...
				<f7-pages>
					<f7-page>
						<f7-block>
							<f7-grid>
								<f7-col width="50">
									<div style="margin:0px;" class="card demo-card-header-pic">
  <img style="width:100%;" src="https://i.pinimg.com/736x/33/b8/69/33b869f90619e81763dbf1fccc896d8d--lion-logo-modern-logo.jpg" valign="bottom" class="card-header color-white no-border">
  ...
  <div class="card-footer">
    ...
    <a href="#" class="link">Read more</a>
				...
				<f7-toolbar tabbar>
  <f7-link class="f7-icons" style="font-size:20px" tab-link="#tab1">home</f7-link>
  <f7-link class="f7-icons" style="font-size:20px" tab-link="#tab1">heart</f7-link>
  <f7-link class="f7-icons" style="font-size:20px" tab-link="#tab1">login</f7-link>
  <f7-link class="f7-icons" style="font-size:20px" tab-link="#tab1">person</f7-link>
</f7-toolbar>
			</f7-view>
		</f7-views>
